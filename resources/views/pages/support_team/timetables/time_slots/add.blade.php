<div class="row">
    <div class="col-md-12">
        <div class="alert alert-info text-center">
            <span>Жаны убакыт аралыктарын кошо аласын же Мурунку башка расписание убакыт аралыктарын колдонунууну танда. <strong>NB:</strong> Мурунку убакыт аралыктарын колдонуу учурдагы расписаниени баштапкы абалга келтирет</span>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header header-elements-inline bg-danger">
                <h6 class="font-weight-bold card-title">Убакыт аралыктарын кошуу</h6>
                {!! Qs::getPanelOptions() !!}
            </div>
                ...
                <div class="col-md-12">
                    <form data-reload="#time_slots_table" class="ajax-store" method="post" action="{{ route('ts.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <select data-placeholder="Саат" required class="select-search form-control" name="hour_from" id="hour_from">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <select data-placeholder="Минута" required class="select-search form-control" name="min_to" id="min_to">
                            ...
                            <div class="col-lg-3">
                                <select data-placeholder="Меридиан" required class="select form-control"
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header header-elements-inline bg-dark">
                <h6 class="font-weight-bold card-title">Мурунку убакыт аралыктарын колдонуу</h6>
                {!! Qs::getPanelOptions() !!}
            </div>
                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('ts.use', $ttr->id) }}">
                        ...
                        <div class="form-group">
                            <label for="ttr_id" class="col-form-label-lg font-weight-semibold mb-lg-2">Мурунку убакыт аралыктарын колдонуу <span class="text-danger">*</span></label>

                            <div class="col-lg-8">
                                <select id="ttr_id" data-placeholder="Тандоо..." required class="select-search form-control-lg" name="ttr_id">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-lg btn-success">Сактоо<i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
